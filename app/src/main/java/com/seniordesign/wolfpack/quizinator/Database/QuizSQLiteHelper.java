   ...
   static final String DECK_COLUMN_OWNER = "_owner";
    ...
    private void setDefaultCardSet(SQLiteDatabase db) {
        ...
        StringBuilder queryBuilder = new StringBuilder()
                ...
                .append(" SELECT \'" + "2" + "\' AS \'" + CARD_COLUMN_ID + "\',")
                    .append("\'").append(Constants.CARD_TYPES.MULTIPLE_CHOICE.ordinal()).append("\' AS \'").append(CARD_COLUMN_CARDTYPE).append("\',")
                    .append("\'").append("What is the symbol for Iron?").append("\' AS \'").append(CARD_COLUMN_QUESTION).append("\',")
                    .append("\'").append("Fe").append("\' AS \'").append(CARD_COLUMN_CORRECTANSWER).append("\',")
                    .append("\'").append(gson.toJson(new String[]{"Fe", "Ir", "I", "C"})).append("\' AS \'").append(CARD_COLUMN_POSSIBLEANSWERS).append("\',")
                    .append("\'").append("1").append("\' AS \'").append(CARD_COLUMN_POINTS).append("\',")
                    .append("\'").append(String.valueOf(false)).append("\' AS \'").append(CARD_COLUMN_MODERATORNEEDED).append("\' ")
                .append(" SELECT \'" + "3" + "\' AS \'" + CARD_COLUMN_ID + "\',")
                    .append("\'").append(Constants.CARD_TYPES.MULTIPLE_CHOICE.ordinal()).append("\' AS \'").append(CARD_COLUMN_CARDTYPE).append("\',")
                    .append("\'").append("Who was the 2nd president of the US?").append("\' AS \'").append(CARD_COLUMN_QUESTION).append("\',")
                    .append("\'").append("John Adams").append("\' AS \'").append(CARD_COLUMN_CORRECTANSWER).append("\',")
                    .append("\'").append(gson.toJson(new String[]{"George Washington", "Thomas Jefferson", "Abraham Lincoln", "John Adams"})).append("\' AS \'").append(CARD_COLUMN_POSSIBLEANSWERS).append("\',")
                    .append("\'").append("1").append("\' AS \'").append(CARD_COLUMN_POINTS).append("\',")
                    .append("\'").append(String.valueOf(false)).append("\' AS \'").append(CARD_COLUMN_MODERATORNEEDED).append("\' ")
                .append(" SELECT \'" + "4" + "\' AS \'" + CARD_COLUMN_ID + "\',")
                    .append("\'").append(Constants.CARD_TYPES.MULTIPLE_CHOICE.ordinal()).append("\' AS \'").append(CARD_COLUMN_CARDTYPE).append("\',")
                    .append("\'").append("What restaurant chain has the Golden Arches?").append("\' AS \'").append(CARD_COLUMN_QUESTION).append("\',")
                    .append("\'").append("McDonald\'s").append("\' AS \'").append(CARD_COLUMN_CORRECTANSWER).append("\',")
                    .append("\'").append(gson.toJson(new String[]{"McDonald\'s", "Wendy\'s", "Subway", "Burger King"})).append("\' AS \'").append(CARD_COLUMN_POSSIBLEANSWERS).append("\',")
                    .append("\'").append("1").append("\' AS \'").append(CARD_COLUMN_POINTS).append("\',")
                    .append("\'").append(String.valueOf(false)).append("\' AS \'").append(CARD_COLUMN_MODERATORNEEDED).append("\' ")
                .append(" SELECT \'" + "5" + "\' AS \'" + CARD_COLUMN_ID + "\',")
                    .append("\'").append(Constants.CARD_TYPES.MULTIPLE_CHOICE.ordinal()).append("\' AS \'").append(CARD_COLUMN_CARDTYPE).append("\',")
                    .append("\'").append("Which of the following is a coastal state?").append("\' AS \'").append(CARD_COLUMN_QUESTION).append("\',")
                    .append("\'").append("Maine").append("\' AS \'").append(CARD_COLUMN_CORRECTANSWER).append("\',")
                    .append("\'").append(gson.toJson(new String[]{"Maine", "Wisconsin", "Idaho", "Tennessee"})).append("\' AS \'").append(CARD_COLUMN_POSSIBLEANSWERS).append("\',")
                    .append("\'").append("1").append("\' AS \'").append(CARD_COLUMN_POINTS).append("\',")
                    .append("\'").append(String.valueOf(false)).append("\' AS \'").append(CARD_COLUMN_MODERATORNEEDED).append("\' ")
